...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, require('@theia/languages/lib/browser/languages-frontend-module'));
        await load(container, require('@theia/json/lib/browser/json-frontend-module'));
